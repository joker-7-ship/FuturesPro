...
class TestBtcc:
    ...
    # # 下限价单
    # def test_PutLimit(self, server_time, token):
    #     params = {
    #         "token": token,
    ...
    #     validate_response(response, request_params=params)
    # # 限价平仓
    # def test_LimitClose(self, server_time, token):
    #     params = {
    #         "token": token,
    #         "leader_id": 10010000021857,
    #         "market": "BTCUSDT",
    ...
    #         "tm": server_time
    #     }
    #     response = post_request("/btcc_perpetual/order/limit_close", params)
    #     print(params)
    #     validate_response(response, request_params=params)

    # 平仓-市价单
    def test_MarketClose(self, server_time, token):
        params = {
            "token": token,
            "leader_id": 10010000021857,
            "market": "BTCUSDT",
            "position_id": 21302905,
            "amount": "0.01",
            "tm": server_time
        }
        response = post_request("/btcc_perpetual/order/market_close", params)
        print(params)
        validate_response(response, request_params=params)
    ...
    # # 查询交易员与带单子账号的资产
    #
    # def test_ALLAsset(self, server_time, token):
    #     params = {
    #         "token": token,
    #         "leader_id": 10010000021857,
    #         "asset": "USDT",
    #         "user_ids":"10010000021947+10010000021946+10010000021856+10010000021855",
    #         "tm": server_time
    #     }
